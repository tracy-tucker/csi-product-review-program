...
ActiveRecord::Schema.define(version: 2019_11_30_212429) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.integer "application_area_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "slug"
    t.index ["application_area_id"], name: "index_products_on_application_area_id"
  ...
  add_foreign_key "products", "application_areas"
